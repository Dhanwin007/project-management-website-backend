...
router
        ...
        .delete(validateProjectPermission([UserRolesEnum.PROJECT_ADMIN,UserRolesEnum.ADMIN]),createProjectValidator(),validate,deleteProject)
router 
    .route("/:projectId/members")
    .get(getProjectMembers)
    .post(validateProjectPermission(UserRolesEnum),addMemberToProjectValidator(),validate,addMembersToProject)
router
