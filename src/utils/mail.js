...
const sendEmail = async (options) => {
    ...
    (options.mailgenContent)
    const transporter=nodemailer.createTransport({//important
    ...
    try{
        ...
        console.error("error occured while sending the mail,MAke sure that mailtrap credentials are provided oroperly in the .env file");
    }
}
