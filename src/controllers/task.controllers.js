...
import { AvalaibleUserRole, UserRolesEnum ,TaskStatusEnum,AvailableTaskStatuses} from "../utils/constants.js";
...
const updateTask = asyncHandler(async(req,res)=>{
    ...
    const task=await Task.findOneAndUpdate({_id:new mongoose.Types.ObjectId(taskId),project:new mongoose.Types.ObjectId(projectId)},
    {
        title,
        status,
        assignedTo,
